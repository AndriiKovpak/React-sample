...
export type TimezoneControllerGetTimezonesError =
  Fetcher.ErrorWrapper<undefined>;

export type TimezoneControllerGetTimezonesResponse = Schemas.TimezoneDTO[];

export const timezoneControllerGetTimezones = (signal?: AbortSignal) =>
  apiFetch<
    TimezoneControllerGetTimezonesResponse,
    TimezoneControllerGetTimezonesError,
    undefined,
    {},
    {},
    {}
...
export type RssControllerWebhookError = Fetcher.ErrorWrapper<undefined>;

export type RssControllerWebhookVariables = {
  body: Schemas.WebhookDataDTO;
};

export const rssControllerWebhook = (
  variables: RssControllerWebhookVariables,
  signal?: AbortSignal
) =>
  apiFetch<
    undefined,
    RssControllerWebhookError,
    Schemas.WebhookDataDTO,
    {},
    {},
    {}
  >({ url: "/rss/webhook", method: "post", ...variables, signal });

export type RssControllerValidateQueryParams = {
  url: string;
};

export type RssControllerValidateError = Fetcher.ErrorWrapper<undefined>;

export type RssControllerValidateVariables = {
  queryParams: RssControllerValidateQueryParams;
};

export const rssControllerValidate = (
  variables: RssControllerValidateVariables,
  signal?: AbortSignal
) =>
  apiFetch<
    Schemas.ValidateRssFeedDTO,
    RssControllerValidateError,
    undefined,
    {},
    RssControllerValidateQueryParams,
    {}
  >({ url: "/rss/validate", method: "get", ...variables, signal });

export type AuthControllerIsEmailAvailablePathParams = {
  email: string;
};

export type AuthControllerIsEmailAvailableError =
  Fetcher.ErrorWrapper<undefined>;
...
export const authControllerIsEmailAvailable = (
  variables: AuthControllerIsEmailAvailableVariables,
  signal?: AbortSignal
) =>
  apiFetch<
    Schemas.AvailableDTO,
    AuthControllerIsEmailAvailableError,
    undefined,
    {},
    {},
    AuthControllerIsEmailAvailablePathParams
  >({
...
export const authControllerGetSignupToken = (
  variables: AuthControllerGetSignupTokenVariables,
  signal?: AbortSignal
) =>
  apiFetch<
    Schemas.RegisterTokenEntity,
    AuthControllerGetSignupTokenError,
    undefined,
    {},
    {},
    AuthControllerGetSignupTokenPathParams
  >({
...
export const authControllerChangePassword = (
  ...
  apiFetch<
    ...
    Schemas.TokenIdPasswordBody,
    {},
    {},
    {}
  >({ url: "/auth/change-password", method: "post", ...variables, signal });
...
export type AuthControllerSendSignupEmailError =
  Fetcher.ErrorWrapper<undefined>;
...
export const authControllerSendSignupEmail = (
  variables: AuthControllerSendSignupEmailVariables,
  signal?: AbortSignal
) =>
  apiFetch<
    Schemas.SuccessDTO,
    AuthControllerSendSignupEmailError,
    Schemas.SignupEmailBody,
    {},
    {},
    {}
  >({ url: "/auth/send-signup-email", method: "post", ...variables, signal });

export const operationsByTag = {
  timezones: { timezoneControllerGetTimezones },
  rss: { rssControllerWebhook, rssControllerValidate },
  auth: {
